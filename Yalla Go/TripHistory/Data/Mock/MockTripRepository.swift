    ...
    static func sampleTrips() -> [Trip] {
        [
            Trip(id: "trip-1",
                 ...
                 pickupCoordinate: TripCoordinate(latitude: 30.0287, longitude: 31.4090),
                 destinationCoordinate: TripCoordinate(latitude: 30.1219, longitude: 31.4056),
                 price: 185.50,
                 tripType: .black,
                 distance: 14_200,
                 duration: 24 * 60,
            ...
            Trip(id: "trip-2",
                 ...
                 pickupCoordinate: TripCoordinate(latitude: 30.0614, longitude: 31.2197),
                 destinationCoordinate: TripCoordinate(latitude: 30.0444, longitude: 31.2357),
                 price: 42.00,
                 tripType: .uberX,
                 distance: 3_100,
                 duration: 11 * 60,
            ...
            Trip(id: "trip-3",
                 ...
                 pickupCoordinate: TripCoordinate(latitude: 30.0080, longitude: 31.4913),
                 destinationCoordinate: TripCoordinate(latitude: 29.9603, longitude: 31.2569),
                 price: 96.75,
                 tripType: .uberXL,
                 distance: 21_500,
                 duration: 33 * 60,
